...
if __name__ == "__main__":
    app.config['SERVER_NAME'] = 'chenhappylife.cn:443'
    app.run('0.0.0.0', debug=True, port=443,
            ssl_context=("D:\pythonProject\docker_py\SSL证书\chenhappylife.cn.pem", 'D:\pythonProject\docker_py\SSL证书\chenhappylife.cn.key'))